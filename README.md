# Ifanqiang Public Web Resources Directory

这个仓库维护 [爱翻墙](https://ifanqiang.com) 当前公开收录的网址和 YouTube 中文频道导出数据。

爱翻墙是一个面向中文读者的海外公开网站入口导航，整理新闻、社区、学术资料、开发者资源、开放资料、隐私安全、视频、播客和生活工具入口。

仓库名沿用历史名称，但当前数据集的定位是公开网站资源目录，不提供代理/VPN，不写访问教程，也不声明每个目标在所有网络环境下都一定被阻断或可访问。
